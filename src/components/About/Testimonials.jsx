      ...
      <div className="flex flex-col lg:flex-row items-center ml-0 sm:ml-12 md:ml-24 lg:ml-68">
        ...
        <div className="w-full lg:w-1/3 flex flex-col items-center lg:items-start text-center lg:text-left mb-8 lg:mb-0">
          ...
          <div className="flex gap-2 sm:gap-4 mt-4">
            <button onClick={prevSlide} className="w-8 h-8 flex items-center justify-center text-gray-600 hover:bg-gray-100 -ml-0 sm:-ml-12">
              <img src={arrowup} alt="Previous" className="w-4 h-4" />
            </button>
            <button onClick={nextSlide} className="w-8 h-8 text-white rounded-full flex items-center justify-center">
        ...
        <div className="w-full lg:w-2/3 bg-[#0A1428] rounded-lg p-4 sm:p-6 md:p-8 ml-4 sm:ml-24 md:ml-48 lg:ml-180 -mt-0 lg:-mt-64">
          <div className="flex flex-col lg:flex-row gap-4 sm:gap-6">
            {/* First Card */}
            <div className="w-full lg:w-[60%] bg-white shadow-md rounded-lg p-4 sm:p-5 lg:-translate-x-0 sm:lg:-translate-x-24 relative transition-transform duration-300">
            ...
            {/* Second Card */}
            <div className="w-full lg:w-[40%] bg-white shadow-md rounded-lg p-4 sm:p-5 lg:translate-x-0 sm:lg:-translate-x-24 relative transition-transform duration-300">
              <div className="flex items-center gap-2 sm:gap-4">
                <img
              ...
              <p className="text-gray-600 text-xs sm:text-sm mt-2 sm:mt-3">
                <q className="text-base sm:text-lg text-gray-700 italic">
                  "{testimonials[(currentIndex + 1) % testimonials.length].feedback}"
                </q>
              </p>
            </div>
          </div>
