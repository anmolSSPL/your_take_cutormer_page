...
const EnquiryModal = ({ isOpen, onClose }) => {
  ...
  return (
    <>
      {/* Background Overlay with specific color #212121B2 */}
      <div 
        className="fixed inset-0 z-40" 
        onClick={onClose}
        style={{ backgroundColor: '#212121B2' }}  // Using style for exact color with opacity
      />

      <div className="fixed top-0 left-0 right-0 z-50 flex justify-center p-4 sm:p-9">
        <div className="bg-white w-full max-w-2xl relative flex flex-col md:flex-row shadow-[0_0_10px_rgba(0,0,0,0.2)] mt-4 h-auto md:h-[400px] rounded-lg">
          {/* Image Section */}
